														...
														<tbody>
															<tr>
																...
																<td>
																  ...
																  <?php if ($fetch['status']) { ?>
																	<a href="leave_approve.php?id=<?php echo $fetch['id']; ?>" class="btn btn-success">Approve</a>
																	<a href="leave_reject.php?id=<?php echo $fetch['id']; ?>" class="btn btn-danger">Reject</a>
																  <?php } ?>
